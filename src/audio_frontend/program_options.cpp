...
namespace signlang::audio_frontend {
  ...
  auto parse_program_options(int argc, char** argv) -> ProgramOptionsParseResult {
    ...
    const AudioFormatRequest capture_format{optional_u32(parsed_options, "capture-rate"),
                                            optional_u16(parsed_options, "capture-channels")};
    const AudioFormatRequest publish_format{optional_u32(parsed_options, "publish-rate"),
                                            optional_u16(parsed_options, "publish-channels")};
    ...
    return ProgramOptionsParseResult{ProgramOptions{
        ...
        localization_tdoa_weight,
        localization_rms_weight,
        publish_period_ms,
        capture_format,
        publish_format,
