#ifndef SIGNLANG_EYES_AUDIO_FRONTEND_AUDIO_FORMAT_HPP
#define SIGNLANG_EYES_AUDIO_FRONTEND_AUDIO_FORMAT_HPP
...
#endif // SIGNLANG_EYES_AUDIO_FRONTEND_AUDIO_FORMAT_HPP
