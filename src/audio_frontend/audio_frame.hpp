#ifndef SIGNLANG_EYES_AUDIO_FRONTEND_AUDIO_FRAME_HPP
#define SIGNLANG_EYES_AUDIO_FRONTEND_AUDIO_FRAME_HPP
...
#endif // SIGNLANG_EYES_AUDIO_FRONTEND_AUDIO_FRAME_HPP
