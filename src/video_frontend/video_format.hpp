#ifndef SIGNLANG_EYES_VIDEO_FRONTEND_VIDEO_FORMAT_HPP
#define SIGNLANG_EYES_VIDEO_FRONTEND_VIDEO_FORMAT_HPP
...
#endif // SIGNLANG_EYES_VIDEO_FRONTEND_VIDEO_FORMAT_HPP
