#ifndef SIGNLANG_EYES_VIDEO_FRONTEND_VIDEO_FRAME_HPP
#define SIGNLANG_EYES_VIDEO_FRONTEND_VIDEO_FRAME_HPP
...
#endif // SIGNLANG_EYES_VIDEO_FRONTEND_VIDEO_FRAME_HPP
