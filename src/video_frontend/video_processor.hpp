#ifndef SIGNLANG_EYES_EDGEAI_VIDEO_FRONTEND_VIDEO_PROCESSOR_HPP
#define SIGNLANG_EYES_EDGEAI_VIDEO_FRONTEND_VIDEO_PROCESSOR_HPP
...
#endif // SIGNLANG_EYES_EDGEAI_VIDEO_FRONTEND_VIDEO_PROCESSOR_HPP
