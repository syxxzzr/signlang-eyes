#ifndef SIGNLANG_EYES_EDGEAI_VIDEO_FRONTEND_PROGRAM_OPTIONS_HPP
#define SIGNLANG_EYES_EDGEAI_VIDEO_FRONTEND_PROGRAM_OPTIONS_HPP
...
#endif // SIGNLANG_EYES_EDGEAI_VIDEO_FRONTEND_PROGRAM_OPTIONS_HPP
