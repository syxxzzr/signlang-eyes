#ifndef SIGNLANG_EYES_VIDEO_FRONTEND_V4L2_CAPTURE_DEVICE_HPP
#define SIGNLANG_EYES_VIDEO_FRONTEND_V4L2_CAPTURE_DEVICE_HPP
...
#endif // SIGNLANG_EYES_VIDEO_FRONTEND_V4L2_CAPTURE_DEVICE_HPP
