#ifndef SIGNLANG_EYES_ENV_SOUND_DET_AUDIO_RING_BUFFER_HPP
#define SIGNLANG_EYES_ENV_SOUND_DET_AUDIO_RING_BUFFER_HPP
...
#endif // SIGNLANG_EYES_ENV_SOUND_DET_AUDIO_RING_BUFFER_HPP
