#ifndef SIGNLANG_EYES_ENV_SOUND_DET_ENV_SOUND_RESULT_HPP
#define SIGNLANG_EYES_ENV_SOUND_DET_ENV_SOUND_RESULT_HPP
...
#endif // SIGNLANG_EYES_ENV_SOUND_DET_ENV_SOUND_RESULT_HPP
