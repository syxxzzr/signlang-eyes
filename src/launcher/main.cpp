...
static auto build_signlang_det_args(const toml::table& cfg) -> std::vector<std::string> {
  ...
  if (const auto* tbl = cfg["signlang_det"].as_table()) {
    ...
    add_opt_int(args, "--segment-pre-roll", opt_int(*tbl, "segment_pre_roll"));
    add_opt_int(args, "--segment-start-confirmation", opt_int(*tbl, "segment_start_confirmation"));
    add_opt_int(args, "--segment-end-confirmation", opt_int(*tbl, "segment_end_confirmation"));
    add_opt_int(args, "--segment-post-roll", opt_int(*tbl, "segment_post_roll"));
    add_opt_int(args, "--segment-min-frames", opt_int(*tbl, "segment_min_frames"));
    add_opt_int(args, "--segment-max-frames", opt_int(*tbl, "segment_max_frames"));
    add_opt_int(args, "--segment-cooldown-frames", opt_int(*tbl, "segment_cooldown_frames"));
    add_opt_int(args, "--segment-cooldown-ms", opt_int(*tbl, "segment_cooldown_ms"));
    add_opt_double(args, "--segment-start-motion", opt_double(*tbl, "segment_start_motion"));
    add_opt_double(args, "--segment-end-motion", opt_double(*tbl, "segment_end_motion"));
    add_opt_double(args, "--segment-static-presence", opt_double(*tbl, "segment_static_presence"));
    add_opt_double(args, "--segment-motion-alpha", opt_double(*tbl, "segment_motion_alpha"));
    add_opt_double(args, "--segment-min-present-ratio", opt_double(*tbl, "segment_min_present_ratio"));
    add_opt_double(args, "--segment-min-quality", opt_double(*tbl, "segment_min_quality"));
    add_opt_int(args, "--segment-queue", opt_int(*tbl, "segment_queue"));
    add_opt_int(args, "--search-top-k", opt_int(*tbl, "search_top_k"));
    add_opt_double(args, "--dtw-window-ratio", opt_double(*tbl, "dtw_window_ratio"));
    add_opt_double(args, "--dtw-threshold", opt_double(*tbl, "dtw_threshold"));
