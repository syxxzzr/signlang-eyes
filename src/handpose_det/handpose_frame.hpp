#ifndef SIGNLANG_EYES_HANDPOSE_DET_HANDPOSE_FRAME_HPP
#define SIGNLANG_EYES_HANDPOSE_DET_HANDPOSE_FRAME_HPP
...
#endif // SIGNLANG_EYES_HANDPOSE_DET_HANDPOSE_FRAME_HPP
