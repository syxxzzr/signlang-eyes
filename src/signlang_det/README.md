...
| `--max-representative-samples` | `3` | Maximum retained representative prototype samples per gesture |
| `--consecutive-hit-windows` | `2` | Same recognized gesture windows required before publishing |
