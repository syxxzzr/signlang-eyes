#ifndef SIGNLANG_EYES_EDGEAI_HANDPOSE_DET_HANDPOSE_TRANSPORT_HPP
#define SIGNLANG_EYES_EDGEAI_HANDPOSE_DET_HANDPOSE_TRANSPORT_HPP
...
namespace signlang::handpose_det {
  ...
  private:
    ...
    static auto create_video_subscriber(const iox2::Node<iox2::ServiceType::Ipc>& node,
...
#endif // SIGNLANG_EYES_EDGEAI_HANDPOSE_DET_HANDPOSE_TRANSPORT_HPP
